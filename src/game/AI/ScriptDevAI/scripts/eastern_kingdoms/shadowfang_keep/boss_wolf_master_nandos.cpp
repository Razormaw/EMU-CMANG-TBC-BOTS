...
enum { SAY_AGGRO = -1033032, SAY_SLAY = -1033033, SAY_DEATH = -1033034, SPELL_REND = 11572, SPELL_HAMSTRING = 1715, SPELL_ENRAGE = 8599, NPC_NANDOS = 3927 };
struct boss_wolf_master_nandosAI : public ScriptedAI
{
    boss_wolf_master_nandosAI(Creature* pCreature) : ScriptedAI(pCreature) { Reset(); }
...
UnitAI* GetAI_boss_wolf_master_nandos(Creature* pCreature) { return new boss_wolf_master_nandosAI(pCreature); }
void AddSC_boss_wolf_master_nandos() { Script* pNewScript = new Script; pNewScript->Name = "boss_wolf_master_nandos"; pNewScript->GetAI = &GetAI_boss_wolf_master_nandos; pNewScript->RegisterSelf(); }
